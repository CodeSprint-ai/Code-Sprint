    ...
    <div className="h-[calc(100vh-4rem)] flex flex-col overflow-hidden px-3 py-4 sm:px-6 sm:py-6 lg:px-8 w-full">
      <div className="flex w-full flex-1 min-h-0 flex-col overflow-hidden">
        ...
        {paginatedProblems.isError && (
          <div className="rounded-xl border dark:border-red-900/50 border-red-200 dark:bg-red-950/20 bg-red-50 px-6 py-8 text-center dark:text-red-400 text-red-600">
          ...
          <div className="flex min-h-0 flex-1 flex-col">
            {problems.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center py-12">
                <LayoutGrid className="mb-3 h-12 w-12 dark:text-zinc-600 text-zinc-400" />
                <p className="dark:text-zinc-500 text-zinc-600">No problems found.</p>
              </div>
            ) : (
              viewMode === 'cards' ? (
