...
<head>
  ...
  <title>Verify your email – CodeSprint AI</title>
</head>
          ...
          <td style="background:${t.headerBg};padding:22px 28px 18px;border-bottom:1px solid ${t.cardBorder};background-image:radial-gradient(circle,${t.dotColor} 1px,transparent 1px);background-size:20px 20px;">
            <table cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td align="right">
                  <span style="background:${t.badgeBg};border:1px solid ${t.badgeBorder};border-radius:20px;padding:3px 9px;font-size:9px;font-weight:600;color:${t.badgeText};letter-spacing:0.8px;text-transform:uppercase;">AI POWERED</span>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="padding:28px;">
            ...
            <h1 style="margin:0 0 8px;font-size:22px;font-weight:800;color:${t.textPrimary};line-height:1.15;letter-spacing:-0.5px;">
              Verify your email,<br/><span style="color:#10b981;">${name}.</span>
            </h1>
            <p style="margin:0 0 18px;font-size:12px;color:${t.textMuted};">Consistency is key to mastery.</p>

            <!-- Body text -->
            <p style="margin:0 0 22px;font-size:13px;color:${t.textSecondary};line-height:1.7;">
              Your CodeSprint AI account is almost ready. One click to verify and you'll unlock personalized learning paths, AI-powered challenges, and your full sprint dashboard.
            </p>

            <!-- Valid badge -->
            <div style="display:inline-block;background:${t.infoBg};border:1px solid ${t.infoBorder};border-radius:20px;padding:3px 10px;margin-bottom:18px;">
              <span style="font-size:10px;font-weight:600;color:${t.infoText};">&#10003;&nbsp; Link valid for 24 hours</span>
            </div>

            <!-- CTA Button -->
            <div style="margin-bottom:22px;">
              <a href="${url}"
                style="display:block;background:${t.accentBtnBg};color:${t.accentBtnText};text-decoration:none;text-align:center;padding:13px 20px;border-radius:7px;font-size:13px;font-weight:700;letter-spacing:0.2px;">
                Start Sprinting &nbsp;&#8594;
              </a>
            </div>
            ...
            <!-- Info box -->
            <div style="background:${t.infoBg};border:1px solid ${t.infoBorder};border-radius:7px;padding:10px 14px;margin-bottom:16px;">
              <p style="margin:0;font-size:12px;color:${t.infoText};line-height:1.5;">
                &#9432;&nbsp; Didn't create this account? You can safely ignore this email — no action is needed.
              </p>
            </div>

            <!-- Fallback link -->
            <p style="margin:0 0 4px;font-size:10px;color:${t.textMuted};">Button not working? Copy this link:</p>
            <p style="margin:0;font-size:10px;color:#10b981;word-break:break-all;">${url}</p>
